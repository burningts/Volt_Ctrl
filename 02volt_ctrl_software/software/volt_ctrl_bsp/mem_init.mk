...
# Memory: epcs_flash
MEM_0 := nios_epcs_flash_boot_rom
...
$(MEM_2)_START := 0x0000c000
$(MEM_2)_END := 0x0000e7ff
$(MEM_2)_SPAN := 0x00002800
$(MEM_2)_HIERARCHICAL_PATH := rom
$(MEM_2)_WIDTH := 32
...
.PHONY: rom
rom: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

...
SOPCINFO_FILE := E:/master_WHU/voltage_control/02volt_ctrl_software/nios_ii/nios.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x31020
SOPC_SYSID_FLAG += --sidp=0x31020
ELF_PATCH_FLAG  += --sidp 0x31020

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1624366237
SOPC_SYSID_FLAG += --timestamp=1624366237
ELF_PATCH_FLAG  += --timestamp 1624366237
